      ...
      <ul className="flex items-center justify-center gap-2 md:gap-6 px-2 md:px-4 py-1.5 md:py-3">
        ...
        <li className="relative" onBlur={handleBlur}>
          ...
          {openMenu === 'propiedades' && (
            <ul className="absolute left-0 top-full mt-1 w-56 bg-white border border-neutral-200 rounded shadow-lg z-20">
              <li><button onClick={() => handleNavigation('/properties/sale')} className="w-full text-left block px-4 py-2 text-sm text-neutral-900 hover:bg-primary/10 transition-colors">Ventas</button></li>
              <li><button onClick={() => handleNavigation('/properties/rent')} className="w-full text-left block px-4 py-2 text-sm text-neutral-900 hover:bg-primary/10 transition-colors">Arriendos</button></li>
              <li><button onClick={() => handleNavigation('/services/management')} className="w-full text-left block px-4 py-2 text-sm text-neutral-900 hover:bg-primary/10 transition-colors">Administraciones</button></li>
            </ul>
          )}
        </li>
        ...
        <li className="relative hidden md:list-item" onBlur={handleBlur}>
          ...
          {openMenu === 'nosotros' && (
            <ul className="absolute left-0 top-full mt-1 w-56 bg-white border border-neutral-200 rounded shadow-lg z-20">
              <li>
                <button onClick={() => handleNavigation('/aboutUs')} className="w-full text-left px-4 py-2 text-sm text-neutral-900 hover:bg-primary/10 transition-colors">
                  Quiénes somos
                </button>
              </li>
              <li>
                <button onClick={() => handleNavigation('/ourTeam')} className="w-full text-left px-4 py-2 text-sm text-neutral-900 hover:bg-primary/10 transition-colors">
                  Nuestro Equipo
                </button>
              </li>
              <li>
                <button onClick={() => handleNavigation('/testimonials')} className="w-full text-left px-4 py-2 text-sm text-neutral-900 hover:bg-primary/10 transition-colors">
                  Testimonios
                </button>
              </li>
            </ul>
        ...
        {/* --- Vende tu Propiedad --- */}
        <li>
          <button onClick={() => handleNavigation('/sell-property')} className="text-xs md:text-sm font-medium text-neutral-900 hover:text-primary uppercase tracking-wide">
            Vende tu Propiedad
          </button>
        </li>
        ...
        <li>
          <button onClick={() => handleNavigation('/rent-property')} className="text-xs md:text-sm font-medium text-neutral-900 hover:text-primary uppercase tracking-wide">
            Arrienda tu Propiedad
          </button>
        </li>
        ...
        <li className="hidden md:list-item">
          <button onClick={() => handleNavigation('/valuation')} className="text-xs md:text-sm font-medium text-neutral-900 hover:text-primary uppercase tracking-wide">
            Valoriza tu Propiedad
          </button>
        </li>
        ...
        <li className="hidden sm:block">
          <button onClick={() => handleNavigation('/blog')} className="text-xs md:text-sm font-medium text-neutral-900 hover:text-primary uppercase tracking-wide">
            Blog
          </button>
        </li>
