...
import { Testimonial } from '@/features/cms/actions/testimonials.action'
    ...
    <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10">
      ...
      {testimonials.length > limit && (
        <div className="mt-6 text-center">
          <a href="/testimonials" className="text-sm text-primary hover:underline">Ver todos los testimonios</a>
        </div>
      )}
    </section>
  )
