...
import { PropertySalesDetailPage } from '@/features/properties/components/sales/detail';
...
export default async function PropertySalesDetailRoutePage({ params }: PageProps) {
